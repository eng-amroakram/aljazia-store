    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <a class="btn btn-primary font-weight-bolder" href="{{route('admin.stores.index')}}">
                        ...
                        @if ($stores->count() > 0)
                            @foreach ($stores as $store)
                                <tr>
                                    ...
                                    <td> <span class=" {{ $store->status == 'active' ? 'label label-lg font-weight-bold label-light-primary label-inline' : 'label label-lg font-weight-bold label-light-danger label-inline' }} ">{{ $store->status == 'active' ? 'مفعل' : 'معطل' }} </span> </td>

                                    <td>
                                        <a href="#" class="btn btn-sm btn-clean btn-icon" title="مناديب المتجر">
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-sm btn-clean btn-icon" title="مدراء المتجر">
                                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                    height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.store-products.search', $store->id) }}"
                                    ...
                                    <td>
                                        <x-buttons.admin.restore page="store"
                                        id="restoreStore{{ $store->id }}"
                                        restoretitle="استراجاع المتجر {{ $store->name }}"
                                        action="{{ route('admin.stores.restore', $store) }}"
                                        method="PUT"  :store="$store" />
                                    </td>

                                    <td>
                                        <x-buttons.admin.force_delete page="store"
                                        id="forceDeleteStore{{ $store->id }}"
                                        forcedeletetitle="حذف الادمن {{ $store->name }} نهائيا"
                                        action="{{ route('admin.stores.force-delete', $store) }}"
