...
class StoreStoreManagerRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'email' => 'required|unique:store_managers,email',
            'role' => 'required|in:manager,supermanager',
            'phone_number' => 'required|string|max:255|unique:store_managers,phone_number',
